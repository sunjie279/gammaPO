...
def main():
    ...
    #########################
    # Instantiate SimPO or DPO trainer
    #########################
    if training_args.trainer_type == "simpo":
    ...
    elif training_args.trainer_type == "dpo":
        trainer = XPOTrainer(
            model=model,
            ref_model=model,
        ...
        raise ValueError(f"Trainer type {training_args.trainer_type} not supported, please choose either 'simpo' or 'dpo'")
